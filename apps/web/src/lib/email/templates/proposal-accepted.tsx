  ...
  return (
    <Html lang="pt-BR">
      ...
      <Body style={{ backgroundColor: '#f8fafc', fontFamily: 'sans-serif' }}>
        ...
        >
          <Heading style={{ color: '#1e1e1e', fontSize: 24 }}>Sua proposta foi aceita!</Heading>
          <Text style={{ color: '#1e1e1e', fontSize: 14 }}>
            Parabéns, {carrierName}! O customer aceitou sua proposta de {price} pro frete
            &ldquo;{shipmentDescription}&rdquo;. Você foi selecionado.
          </Text>
