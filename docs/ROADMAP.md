...
**Status:** Sprint 3 em andamento — S3-T1 ✅, S3-T2 ✅, próximo: S3-T3 (Delivery confirm)
...
| S6-T2 | WhatsApp notifications — Meta Cloud API, templates aprovados | ○ | [→](tasks/s6-t2-whatsapp-notifications/) |
...
> Após todos os sprints de API: construir a interface por fluxo, consumindo os endpoints já testados.

Tasks definidas após Sprint 7 concluído.
